...
%% 
    slices_destination_path = ['../Dataset/', action, '_data/', action, '_data_png/slices/'];
    masks_destination_path = ['../Dataset/', action, '_data/', action, '_data_png/masks/'];   
...
% save preprocessed images
 ...
 % center crop to 256x256 square
    ...
    for s = size(slices, 3):-slicesPerImage:1
        ...
        saveastiff(maskSlices, [masks_destination_path prefix '_' num2str(easy_sort + startSlice) '.tif']);
