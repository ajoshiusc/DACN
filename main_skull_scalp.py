...
def configure():
    ...
    #—————————————————————————————————————————————————————# 
    flags.DEFINE_string('data_dir', './hcp_data_skull_scalp/h5py/', 'Name of data directory')
    flags.DEFINE_string('train_data', 'train_data.hdf5', 'Training data')
    ...
    flags.DEFINE_string('modeldir', './network_skull_scalp/modeldir/', 'Model dir')
    flags.DEFINE_string('sample_dir', './network_skull_scalp/samples/', 'Sample directory')
    flags.DEFINE_string('sample_net_dir', './network_skull_scalp/samples_net/', 'Sample directory')
    flags.DEFINE_string('record_dir', './network_skull_scalp/record/', 'Experiment record directory')
    #————————————————————————————-—————————————————————————# 
