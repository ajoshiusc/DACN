...
slices_path = glob.glob('./BSEDataset/' + action + '_data/' + action + '_data_bmp/slices/*.bmp')
masks_path = glob.glob('./BSEDataset/' + action + '_data/' + action + '_data_bmp/masks/*.bmp')
...
h5py_file_name = './BSEDataset/h5py/' + action + '_data.hdf5'
